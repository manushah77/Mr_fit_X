                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          'The body mass index (BMI) calculator can be used\n to calculate BMI value and corresponding weight\n status while taking age into consideration.',
                          style: TextStyle(
